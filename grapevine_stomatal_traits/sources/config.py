...
class SiteData(object):
    def __init__(self, pheno_data: PhenoData, latitude: float, longitude: float,
                 ...
                 spacing_intrarow: float, soil_depth: float, rhyzo_coeff: float, avg_root_radius: float, root_length: float,
        ...
        self.avg_root_radius = avg_root_radius
...
class ScenariosTraits(Enum):
    baseline: dict = {"g0": 0.01145, 'm0': 5.60, 'psi0': -1.27}
    low_gmax: dict = {"g0": 0.01145, 'm0': 1.91, 'psi0': -1.27}
    high_gmax: dict = {"g0": 0.01145, 'm0': 7.81, 'psi0': -1.27}
    high_gsp50: dict = {"g0": 0.01145, 'm0': 5.60, 'psi0': -0.93}
    low_gsp50: dict = {"g0": 0.01145, 'm0': 5.60, 'psi0': -1.54}
    elite: dict = {"g0": 0.01165, 'm0': 0.9969, 'psi0': -0.85}
